...
export const products: Product[] = [
  {
    ...
    price: 29.99,
    images: ["/Classic White T-Shirt.png?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "men",
  ...
  },
  {
    ...
    price: 59.99,
    images: ["/Slim Fit Jeans.jpg?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "men",
    subcategory: "jeans",
  ...
  },
  {
    ...
    price: 49.99,
    images: ["/Floral Summer Dress.png?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "women",
    subcategory: "dresses",
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    price: 79.99,
    images: ["/Leather Crossbody Bag.jpg?height=600&width=400", "/placeholder.svg?height=600&width=400"],
  ...
  },
  {
    ...
    price: 69.99,
    originalPrice: 89.99,
    images: ["/Oversized Knit Sweater.jpg?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "women",
  ...
  },
  {
    ...
    price: 129.99,
    images: ["/Tailored Blazer.jpg?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "women",
    subcategory: "jackets",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 34.99,
    images: ["/Athletic Performance Shorts.jpg?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "men",
    subcategory: "shorts",
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    images: ["/Minimalist Watch.jpg?height=600&width=400", "/placeholder.svg?height=600&width=400"],
    category: "accessories",
    subcategory: "watches",
    colors: ["Black/Brown", "Silver/Black", "Gold/Brown"],
